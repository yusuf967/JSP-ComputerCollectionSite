...
<%
        ...
        String urun_cins = request.getParameter("urun_cins");
        int sayfa = 0;
        ...
        List<urunler> urunList = db.urun_cins_ara(urun_cins, sayfa);
               ...
               <input class="w-100 h-100 form-ara-input-text" type="text" name="ürün_ad" placeholder="Ürün,kategori veya marka ara">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                      <div class="card" style="width: 18rem;">
                       <a href="single-product.jsp?urun_id=<%out.println(urunList.get(i).getUrun_id());%>">
                        ...
                        <div class="card-body" style="height: 250px;">
                          <h5 class="card-title"><%out.println(urunList.get(i).getUrun_fiyat());%> TL</h5>
                          ...
                          <a href="<%out.println(urunList.get(i).getUrun_link());%>" class="btn btn-primary" target="blank">Ürün Linki</a>
                        </div>
                      </div>
                    </div>
                    <%}%>
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-end">
                    <li class="page-item">
                      <a class="page-link" href="filter.jsp?sayfa=<%=sayfa - 1%>&urun_cins=<%=request.getParameter("urun_cins")%>">ÖNCEKİ SAYFA</a>
                    </li>
                    <li class="page-item">
                      <a class="page-link" href="filter.jsp?sayfa=<%=sayfa + 1%>&urun_cins=<%=request.getParameter("urun_cins")%>">SONRAKİ SAYFA</a>
                    </li>
                  </ul>
                </nav>
                <!--PAGİNATİON BİTİŞ-->
