                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="card mb-3 bg-light">
                            <img class="card-img-top" style="width: 270px;height: 180px; object-fit: contain;" src="<%out.println(urun.getUrun_resim());%>" alt="Card image cap">
                            <div class="card-body">
                              <h5 class="card-title"><%out.println(urun.getUrun_ad());%></h5>
                              <p class="card-text text-primary"><%out.println(urun.getUrun_marka());%></p>
                              <p class="card-text text-danger"><%out.println(urun.getUrun_fiyat());%> TL</p>
                              <p class="card-text text-dark">Ürün Değerlendirme Puanı: <%out.println(urun.getUrun_skor());%></p>
                              <a class="sepet-links" href="sepet-ekle-controller.jsp?urun_id=<%out.println(urun.getUrun_id());%>" target="_blank">Sepete Ekle</a>
                              <a class="sepet-links" href="<%out.println(urun.getUrun_link());%>" target="_blank">Ürün Link</a>
                              <p class="card-text text-danger">ÜRÜN AÇIKLAMASI</p>
                              <p class="card-text">                                       <%
                                String[] ozellikler = urun.getUrun_ozellik().split(";;;;;");
                                for (String ozellik : ozellikler) {
                                    out.println(ozellik);
                                }%>
                              </p>
                            </div>
